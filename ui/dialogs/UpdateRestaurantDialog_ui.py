...
################################################################################
## Form generated from reading UI file 'UpdateRestaurantDialog.ui'
##
...
class Ui_UpdateRestaurantDialog(object):
...
"\n"
"")
        self.label = QLabel(UpdateRestaurantDialog)
        ...
        self.layoutWidget = QWidget(UpdateRestaurantDialog)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(30, 80, 481, 491))
        ...
        self.lineEdit_address_2 = QLineEdit(self.layoutWidget)
        self.lineEdit_address_2.setObjectName(u"lineEdit_address_2")
        self.lineEdit_address_2.setMinimumSize(QSize(0, 35))
        self.lineEdit_address_2.setMaximumSize(QSize(16777215, 35))

        self.verticalLayout_2.addWidget(self.lineEdit_address_2)
        ...
        self.layoutWidget1 = QWidget(UpdateRestaurantDialog)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(210, 590, 301, 42))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.btn_updateRestaurant = QPushButton(self.layoutWidget1)
        self.btn_updateRestaurant.setObjectName(u"btn_updateRestaurant")
        self.btn_updateRestaurant.setMinimumSize(QSize(0, 40))
        self.btn_updateRestaurant.setStyleSheet(u"QPushButton{\n"
...
"}")
        ...
        self.line = QFrame(UpdateRestaurantDialog)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(0, 60, 541, 20))
        self.line.setFrameShape(QFrame.Shape.HLine)
        self.line.setFrameShadow(QFrame.Shadow.Sunken)

        self.retranslateUi(UpdateRestaurantDialog)

        QMetaObject.connectSlotsByName(UpdateRestaurantDialog)
    # setupUi
    ...
    def retranslateUi(self, UpdateRestaurantDialog):
        ...
        self.label_4.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Category", None))
        self.label_5.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Phone", None))
        self.label_6.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Schedule", None))
        self.label_7.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Qualification", None))
        self.btn_updateRestaurant.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Update Restaurant", None))
        self.btn_cancel.setText(QCoreApplication.translate("UpdateRestaurantDialog", u"Cancel", None))
    # retranslateUi
